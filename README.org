...
the 27th of September, 2021 (see [[https://github.com/tagteam/hTMLEne#course-location][course location]]). \\
...
2. A list of relevant =R= packages for the practicals can be found
   here: 
   [[https://github.com/tagteam/hTMLEne#relevant-r-packages][Relevant
   R packages]].

3. For an overview of the course, see: [[https://github.com/tagteam/hTMLEne#overview-of-course][Overview of course]].

4. To prepare for the lectures, see: [[https://github.com/tagteam/hTMLEne#reading-plan][Reading plan]].
